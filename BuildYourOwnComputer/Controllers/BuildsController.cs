...
//THESE USING STATEMENTS CAME WITH CODE FROM .MVC TEMPLATE. EVEN THOUGH SOME ARE REDUNDANT, KEEPING THE BLOCK UNDISTURBED.
...
//THE COMMENTED CODE IMMEDIATELY BELOW IS FROM API TEMPLATE. JON'S CODE IS JUST UNDERNEATH.

//namespace BuildYourOwnComputer.Controllers
//{
...
//        public async Task<IHttpActionResult> GetBuild(long id)
//        {
//            Build build = await db.Build.FindAsync(id);
//            if (build == null)
//            {
//                return NotFound();
//            }
...
//        public async Task<IHttpActionResult> PutBuild(long id, Build build)
//        {
...
//        // POST: api/Builds
//        [ResponseType(typeof(Build))]
//        public async Task<IHttpActionResult> PostBuild(Build build)
//        {
//            if (!ModelState.IsValid)
//            {
//                return BadRequest(ModelState);
...
//        // DELETE: api/Builds/5
//        [ResponseType(typeof(Build))]
//        public async Task<IHttpActionResult> DeleteBuild(long id)
//        {
//            Build build = await db.Build.FindAsync(id);
//            if (build == null)
//            {
